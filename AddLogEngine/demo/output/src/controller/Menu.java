 ...
 */
public class Menu {
    public static void menu(ArrayList<Fruit> fruitList, Hashtable<String, ArrayList<Fruit>> orderTable){CG.log("IN1 - 4482837211: { row: 22 }");
        int choice;
        ...
        //Process
CG.log("OUT2 - 5613130439: { row: 29 }");CG.log("IN2.1 - 5613130439: ");        while(true){
...
CG.log("IN4 - 8198082655: { row: 52 }");        }CG.log("OUT3 - 5613130439: { row: 52 }");
    CG.log("OUT5 - 8198082655: { row: 53 }");} 
}
